...
class TestPostCreationFlow:
    ...
    async def test_full_post_creation_flow(self):
        ...
        with patch.dict(os.environ, {
            ...
            mock_client.create_draft = Mock(return_value={
                "id": "post-123",
                "title": "My Test Post",
            ...
            with patch('src.handlers.auth_handler.SubstackApi', return_value=mock_client):
...
That's all for now!"""
                ...
                mock_client.post_draft = Mock(return_value={
                    "id": "post-123",
                    "title": "My Test Post",
                    "subtitle": "A test subtitle",
                    "url": "https://test.substack.com/p/my-test-post"
    ...
    async def test_update_and_publish_flow(self):
        ...
        with patch.dict(os.environ, {
            ...
            # Mock the Substack API
            mock_client = Mock()
            mock_client.update_draft = Mock(return_value={
                "id": "post-789",
                "title": "Updated Post"
            })
            mock_client.publish_draft = Mock(return_value={
                "id": "post-789",
                "published": True,
    ...
    async def test_list_drafts_flow(self):
        ...
        with patch.dict(os.environ, {
            ...
            # Mock the Substack API
            mock_client = Mock()
            mock_client.get_drafts = Mock(return_value=[
