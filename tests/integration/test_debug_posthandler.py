...
Another paragraph."""
        ...
        print(f"✅ PostHandler published: https://neroaugustus.substack.com/p/{pub2.get('slug')}")
        ...
        if pub1_body and pub2_body:
            ...
            if p2_parsed.get('content'):
                print(f"PostHandler first block type: {p2_parsed['content'][0].get('type')}")
