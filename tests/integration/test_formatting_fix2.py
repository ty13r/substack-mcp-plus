...
async def test_formatting_fix2():
    ...
    try:
        ...
        post.paragraph().text("This is ").text("bold text").marks([{"type": "strong"}]).text(" and this is ").text("italic text").marks([{"type": "em"}]).text(".")
        
        # Test inline code
        post.paragraph().text("Here's some ").text("inline code").marks([{"type": "code"}]).text(" mixed with regular text.")
        
        # Test link
        post.paragraph().text("Here's a ").text("link to Substack").marks([{"type": "link", "href": "https://substack.com"}]).text(".")
        ...
        post.paragraph().text("Combined: ").text("bold and italic").marks([{"type": "strong"}, {"type": "em"}]).text(" text.")
